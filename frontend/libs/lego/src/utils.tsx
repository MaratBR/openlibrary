...
type OnlyComponentTypes<TModule extends object> = {
  [K in keyof TModule]: TModule[K] extends React.ComponentType<object>
    ? K
    : never;
};
...
export function componentsChunk<TModule extends object>(
  fn: () => Promise<TModule>,
) {
  ...
  function element<K extends OnlyComponentTypeKeys<TModule>>(
    key: K,
  ): React.JSX.Element {
...
export function setRef<T>(
  ref: React.MutableRefObject<T> | React.RefCallback<T>,
  value: T,
) {
