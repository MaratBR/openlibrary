...
let InstantClick = (function (d, e) {
  ...
  function N(a) {
    G > +new Date() - 500 ||
      ((a = z(a.target)) &&
        A(a) &&
        (a.addEventListener('mouseout', T), H ? ((O = a.href), (l = setTimeout(x, H))) : x(a.href)))
  }
  function U(a) {
    G = +new Date()
    ;(a = z(a.target)) &&
      A(a) &&
      (D ? a.removeEventListener('mousedown', M) : a.removeEventListener('mouseover', N), x(a.href))
  }
  function V(a) {
    let b = z(a.target)
      ...
      if (p.getResponseHeader('Content-Type').match(/\/(x|ht|xht)ml/)) {
        ...
        for (var a = a.head.children, b = 0, c, g = a.length - 1; 0 <= g; g--)
          if (((c = a[g]), c.hasAttribute('data-instant-track'))) {
            ...
            for (let e = E.length - 1; 0 <= e; e--) E[e] == c && b++
          }
        b != E.length && (F = !0)
      } else F = !0
      m && ((m = !1), P(r))
  ...
  function L(a) {
    ...
    if (!a) {
      ...
      for (j = a.length; i < j; i++)
        (b = a[i]),
          b.hasAttribute('data-no-instant') ||
  ...
  function x(a) {
    ;(!D && 'display' in q && 100 > +new Date() - (q.start + q.display)) ||
      (l && (clearTimeout(l), (l = !1)), a || (a = O), v && (a == r || m)) ||
      ((v = !0),
      (m = !1),
      (r = a),
      (F = u = !1),
  ...
  function P(a) {
    ...
    l || !v
      ? l && r && r != a
        ? (e.href = a)
        : (x(a), C.start(0, !0), t('wait'), (m = !0))
      : m
        ? (e.href = a)
        : F
          ? (e.href = r)
          : u
            ? ((h[k].scrollY = pageYOffset), (m = v = !1), K(y, u, r))
            : (C.start(0, !0), t('wait'), (m = !0))
  }
  var I = navigator.userAgent,
    ...
    C = (function () {
      ...
      function e() {
        d.getElementById(f.id)
          ? (clearTimeout(l), (n = 100), g(), (f.style.opacity = '0'))
          : (a(100 == n ? 0 : n), setTimeout(e, 0))
      }
      function m() {
        f.style.left = `${pageXOffset}px`
        f.style.width = `${innerWidth}px`
        f.style.top = `${pageYOffset}px`
        let a = 'orientation' in window && 90 == Math.abs(orientation)
      ...
      return {
        init() {
          ...
          a.innerHTML = `#instantclick{position:${
            Q ? 'absolute' : 'fixed'
    ...
    R =
      'pushState' in history && (!I.match('Android') || I.match('Chrome/')) && 'file:' != e.protocol
  return {
    supported: R,
    init() {
      if (!k)
        if (R) {
          ...
          for (var b = d.head.children, c, a = b.length - 1; 0 <= a; a--)
            (c = b[a]),
              c.hasAttribute('data-instant-track') &&
                ((c = c.getAttribute('href') || c.getAttribute('src') || c.innerHTML), E.push(c))
          ...
          addEventListener('popstate', function () {
            ...
            a != k &&
              (a in h
                ? ((h[k].scrollY = pageYOffset),
                  (k = a),
                  K(h[a].title, h[a].body, !1, h[a].scrollY))
                : (e.href = e.href))
          })
        } else t('change', !0)
    },
