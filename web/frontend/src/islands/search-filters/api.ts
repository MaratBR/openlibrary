...
export function getQueryParams(query: DetailedBookSearchQuery): URLSearchParams {
  ...
  if (query.favorites.min !== null) params.set('f.min', query.favorites.min.toString())
  if (query.favorites.max !== null) params.set('f.max', query.favorites.max.toString())
