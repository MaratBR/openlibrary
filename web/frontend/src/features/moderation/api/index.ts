...
export type {
  ...
  ModerationReportDecisionRequest as ModerationReportDecision,
  ModerationReportsSearchResponse as ModerationReportsSearch,
  ModerationBookResponse as ModerationBook,
  ModerationBookListEntryResponse as ModerationBookListEntry,
  ModerationBooksPageResponse as ModerationBooksPage,
