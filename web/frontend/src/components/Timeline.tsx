...
function TimelineItem({
  ...
  return (
    <li className={cn('Timeline-item grid grid-cols-[2rem_1fr] gap-3', className)} {...props}>
      <div className="flex flex-col items-center">
        <span className="w-8 h-8 rounded-full bg-secondary grid place-items-center text-secondary-foreground">
          {marker}
        </span>
        <span className="Timeline-connector w-px flex-1 bg-border min-h-8" aria-hidden="true" />
      </div>
