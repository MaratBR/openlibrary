...
func bookReadingList(ctx context.Context, bookID int64, readingListStatus app.Nullable[app.BookReadingListDto]) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 7, "</button><ul x-cloak x-show=\"open\" class=\"flex flex-col gap-2 absolute left-0 right-0 top-16 shadow-lg bg-background p-2 rounded-xl\" @click.outside=\"open=false\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
