...
export default function ChapterEditor({
  ...
  const createChapterMutation = useMutation({
    mutationFn: (req: CreateBookChapterRequest) =>
      httpCreateBookChapter(bookId, req),
  });
              ...
              <FormItem className="flex flex-row items-center justify-between ">
                <div className="space-y-0.5">
                  ...
                  <FormDescription className="max-w-[600px] mr-10">
                    If checked, this chapter will be marked as adults-only. If
                    your book is NOT marked as adults-only, your readers will be
                    informed that only a portion of the content is marked as
                    adult.
                  </FormDescription>
                </div>
                <FormControl>
